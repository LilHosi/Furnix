...
<input type="hidden" name="command" value="ADD" />
  ...
  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="text" id="sample3" name="pronounce">
    <label class="mdl-textfield__label" for="sample3">Pronounce</label>
  </div>
  <br/>
  	<div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="firstName" ></input>
    <label class="mdl-textfield__label" for="sample5">First Name</label>
  </div>
  <br/>
  <div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="lastName" ></input>
    <label class="mdl-textfield__label" for="sample5">Last Name</label>
  </div>
  <br/>
  <div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="preferredName" ></input>
    <label class="mdl-textfield__label" for="sample5">Preferred Name</label>
  </div>
  <br/>
  <div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="username" ></input>
    <label class="mdl-textfield__label" for="sample5">Username</label>
  </div>
  <br/>
  <div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="email" ></input>
    <label class="mdl-textfield__label" for="sample5">Email</label>
  </div>
  <br/>
  <div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="password" ></input>
    <label class="mdl-textfield__label" for="sample5">Password</label>
  </div>
  <br/>
  <div class="mdl-textfield mdl-js-textfield">
    <input class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="phone" ></input>
